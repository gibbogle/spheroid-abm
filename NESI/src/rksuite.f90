...
public :: wp, rk_setup, range_integrate, step_integrate, interpolate, &
...
real, parameter :: gib_count_factor = 1000
...
!  Check for too much work.
         toomch = comm%f_count > max_f_count	!*gib_count_factor
         if (toomch) then
